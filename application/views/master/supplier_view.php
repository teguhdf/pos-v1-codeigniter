        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><b>Supplier</b> <small>(Pemasok Barang)</small></h1>
                    <br>
                    <!-- DataTales Example -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('master/suppliers/ajax_list') ?>",
                    "type": "POST"
                },
        ...
        function save() {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('master/suppliers/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('master/suppliers/ajax_update') ?>";
            }
        ...
        function edit_supplier(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('master/suppliers/ajax_edit') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    //console.log(data);
        ...
        function delete_supplier(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('master/suppliers/ajax_delete') ?>/" + id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data) {
